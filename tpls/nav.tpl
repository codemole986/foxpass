      ...
      <div class="container">
          ...
          <div class="float-right">
            ...
            <div class="navbar-collapse" id="mobile_nav_menu">
              ...
              <ul class="navbar-nav mr-auto">
                <li class="nav-item active"><a class="link" href="#how_it_works">Case Studies</a></li>
                <li class="nav-item"><a class="link" href="#features">Features</a></li>
                <li class="nav-item"><a class="link" href="#">Security</a></li>
                <li class="nav-item"><a class="link" href="#">Team</a></li>
        ...
        <div class="row desktop-menu-row">
          ...
          <div class="right d-flex flex-md-row flex-column justify-content-between col-md-9" style="padding-right: 0;">
            <a class="link py-2 d-none d-md-inline-block" href="#how_it_works">Case Studies</a>
            ...
            <a class="link py-2 d-none d-md-inline-block" href="#">Team</a>
